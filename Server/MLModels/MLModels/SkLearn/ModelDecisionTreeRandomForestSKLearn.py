...
pathDownloads = Constants.pathDownloads
...
def trainDecisionTreeModelAccGyr(threshold, testMin, testMax, preprocessingData):
    ...
    so = platform.system()
    if so == "Windows":
        os.system('copy sklearn_model_dt.onnx '+pathDownloads)
        os.system('del sklearn_model_dt.onnx')
        os.system('copy sklearn_model_dt.ort '+pathDownloads)
        os.system('del sklearn_model_dt.ort')
    if so == "Linux":
        os.system('mv sklearn_model_dt.onnx '+pathDownloads)
...
def trainRandomForestModelAccGyr(threshold, testMin, testMax, preprocessingData):
    ...
    so = platform.system()
    if so == "Windows":
        os.system('copy sklearn_model_rf.onnx '+pathDownloads)
        os.system('del sklearn_model_rf.onnx')
        os.system('copy sklearn_model_rf.ort '+pathDownloads)
        os.system('del sklearn_model_rf.ort')
    if so == "Linux":
        os.system('mv sklearn_model_rf.onnx '+pathDownloads)
...
def trainDecisionTreeModelAcc(threshold, testMin, testMax, preprocessingData):
    ...
    so = platform.system()
    if so == "Windows":
        os.system('copy sklearn_model_dt2.onnx '+pathDownloads)
        os.system('del sklearn_model_dt2.onnx')
        os.system('copy sklearn_model_dt2.ort '+pathDownloads)
        os.system('del sklearn_model_dt2.ort')
    if so == "Linux":
        os.system('mv sklearn_model_dt2.onnx '+pathDownloads)
...
def trainRandomForestModelAcc(threshold, testMin, testMax, preprocessingData):
    ...
    so = platform.system()
    if so == "Windows":
        os.system('copy sklearn_model_rf2.onnx '+pathDownloads)
        os.system('del sklearn_model_rf2.onnx')
        os.system('copy sklearn_model_rf2.ort '+pathDownloads)
        os.system('del sklearn_model_rf2.ort')
    if so == "Linux":
        os.system('mv sklearn_model_rf2.onnx '+pathDownloads)
