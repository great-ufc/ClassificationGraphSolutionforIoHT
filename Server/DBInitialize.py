from Database.DatabaseQueryFunctions import create_table
from Database.DatabaseQueryFunctions import drop_table
from Database.DatabaseQueryFunctions import add_Column
from Database.DatabaseQueryFunctions import update_Column
from Database.DatabaseQueryFunctions import drop_Column
from Database import DBScheme
...
class DBInitialize:
    ...
    def create_tables(self, connection_db):
        ...
        dbScheme = DBScheme.DBScheme(self.connection_db)
        try:
            #Entity tables
